...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/UglyTroLL/Swicon.git", :commit => "6a819b75b09f710ae6dfa64ed07ce69a5cf50a41" }
  s.source_files  = "Swicon/Swicon/*.{swift}"
  s.resources = "Swicon/Swicon/*.ttf"
  s.frameworks = 'UIKit', 'CoreText', 'Dispatch'
